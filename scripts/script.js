...
var FSE = TANKS.slice(0,49);

var tries = 0;
var success = 0;

function startGame() {
    document.getElementById('success_rate').innerHTML = `réussite : 0%`;
...
function answer_good(){
    success++;
    tries++;
    var sr = calculate_success_rate();
    document.getElementById('success_rate').innerHTML = `réussite: ${sr.toFixed(2)}%`;
    loadImage();
}
